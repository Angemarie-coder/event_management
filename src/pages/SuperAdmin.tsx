...
const SuperAdmin: React.FC = () => {
  ...
  if (user.role !== 'super-admin') return <div style={{ color: 'red', textAlign: 'center', marginTop: 40 }}>Access denied. Only super admins can access this page.</div>;
  ...
  return (
    <div style={{ maxWidth: 900, margin: 'auto', padding: 20 }}>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <button onClick={() => setTab('users')} disabled={tab==='users'} style={{ marginLeft: 10 }}>User Management</button>
      </div>
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            {users.map(u => (
              <li key={u.id} style={{ border: '1px solid #ccc', marginBottom: 10, padding: 10 }}>
                ...
                {/* Show Approve button for pending admins */}
